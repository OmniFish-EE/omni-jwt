 ...
 * holder.
 */
// Portions Copyright 2013-2014 Oracle and/or its affiliates.
...
public class JwtKeyStoreUtils {
    ...
    private static CacheableString readKeyFromURL(URL keyURL, Duration defaultCacheTTL) throws IOException {
        ...
        String charEncoding = getCharacterEncoding(urlConnection.getContentType());
    ...
    private static String getCharacterEncoding(final String type) {
        ...
        return charsetValue.replace('"', ' ').trim();
    }
}
