...
It is derived from [Payara's implementation](https://github.com/payara/Payara/tree/master/appserver/payara-appserver-modules/microprofile/jwt-auth) (which was also mainly created by the author of this fork)
